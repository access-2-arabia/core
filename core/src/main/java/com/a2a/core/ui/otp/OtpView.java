...
public class OtpView extends AppCompatEditText {
    ...
    private static final int[] FILLED_STATE = new int[]{R.attr.otpStateFilled};
    ...
    public OtpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        otpViewItemHeight = (int) typedArray.getDimension(R.styleable.OtpView_otpItemHeight, res.getDimensionPixelSize(R.dimen.otp_view_item_size));
        otpViewItemWidth = (int) typedArray.getDimension(R.styleable.OtpView_otpItemWidth, res.getDimensionPixelSize(R.dimen.otp_view_item_size));
        otpViewItemSpacing = typedArray.getDimensionPixelSize(R.styleable.OtpView_otpItemSpacing, res.getDimensionPixelSize(R.dimen.otp_view_item_spacing));
        otpViewItemRadius = (int) typedArray.getDimension(R.styleable.OtpView_otpItemRadius, 0);
        lineWidth = (int) typedArray.getDimension(R.styleable.OtpView_otpLineWidth, res.getDimensionPixelSize(R.dimen.otp_view_item_line_width));
        ...
        cursorWidth = typedArray.getDimensionPixelSize(R.styleable.OtpView_otpCursorWidth, res.getDimensionPixelSize(R.dimen.otp_view_cursor_width));
        itemBackground = typedArray.getDrawable(R.styleable.OtpView_otpItemBackground);
